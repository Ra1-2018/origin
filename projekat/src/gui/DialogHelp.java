...
public class DialogHelp extends JDialog{
	...
	public DialogHelp() {
		...
		String text = 
				...
				"\s 4.1 Ako se predmet nalazi u tabeli sa položenim predmetima, njemu je dodeljena odgovarajuæa ocena i moguæe je poništiti.\n\s Da bi se ocena poništila, potrebno je oznaèiti predmet i kliknuti na dugme Poništi ocenu.\n\r"+
				"\s 4.2 Da bi se dodao novi student na predmet, potrebno je pozicionirati se na tab Nepoloženi i kliknuti dugme Dodaj.\n\r"+
				"\s U okviru taba Nepoloženi moguæe je ukloniti predmete, koje oznaèeni student sluša, tako sto se oznaèi odgovarajuæi predmet i klikne na dugme Ukloni.\n\r"+
				"\s Da bi se polozio predmet iz liste nepolozenih neophodno je oznaèiti neki od predmeta iz tabele nepoloženih predmeta, nakon èega se odabirom dugmeta Polaganje moguce izvrsiti upis ocene\n\r"+
